...
const PIECES = [
  ...
  {
    id: 'slim-case-L',
    name: '1. Slim Screwless Case L (Johnny5iv)',
    path: '01-final/slim-screwless-case/silakka54_top_bottom_left.stl',
    preview: '01-final/previews/preview-slim-case-L.png',
    color: 0x38d39f,
    category: '1. Slim Screwless',
    desc: 'Case slim sem parafusos (esquerda): fundo sólido, encaixe por fricção da PCB e altura reduzida.',
  },
  {
    id: 'slim-case-R',
    name: '1. Slim Screwless Case R (Johnny5iv)',
    path: '01-final/slim-screwless-case/silakka54_top_bottom_right.stl',
    preview: '01-final/previews/preview-slim-case-R.png',
    color: 0x2bb886,
    category: '1. Slim Screwless',
    desc: 'Case slim sem parafusos (direita): base integrada para a PCB AliExpress.',
  },
  {
    id: 'slim-mcu-L',
    name: '1. Slim MCU Cover L',
    path: '01-final/slim-screwless-case/silakka54_mcu_left.stl',
    preview: '01-final/previews/preview-slim-mcu-L.png',
    color: 0xf2a33c,
    category: '1. Slim Screwless',
    desc: 'Cover do MCU por pressão (studs) para a case slim esquerda.',
  },
  {
    id: 'slim-mcu-R',
    name: '1. Slim MCU Cover R',
    path: '01-final/slim-screwless-case/silakka54_mcu_right.stl',
    preview: '01-final/previews/preview-slim-mcu-R.png',
    color: 0x58a6ff,
    category: '1. Slim Screwless',
    desc: 'Cover do MCU por pressão (studs) para a case slim direita.',
  },
  {
    id: 'slim-inner-frame',
